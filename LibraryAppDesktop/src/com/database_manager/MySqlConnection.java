...
public class MySqlConnection {
	...
	static {
		...
		ResourceBundle res = ResourceBundle.getBundle("dbconnectivity");
	...
	public MySqlConnection() {
		try {
			...
			JOptionPane.showMessageDialog(null, res.getString("mysql_no_server"), "Error", JOptionPane.ERROR_MESSAGE);
			System.exit(1);
